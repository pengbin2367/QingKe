...
import { ref } from 'vue'
import { loginUser, loginRules } from "@/views/login/components/loginValidate.ts";
import LoginForm from "@/views/login/components/LoginForm.vue";
import { regisUser, regisRules } from "@/views/login/components/regisValidate.ts";
...
<div class="container" :class="{'sign-up-mode': signUpMode}">
  <div class="forms-container">
    ...
    <!-- Login -->
    <LoginForm :login-rules="loginRules" :login-user="loginUser" />
    <!-- Register -->
    <RegisForm :regis-rules="regisRules" :regis-user="regisUser" />
    </div>
  </div>
  <!-- 左右切换动画 -->
